...
const questions = () => {
    ...
    return inquirer.prompt([
        ...
        },
        {
            ...
            choices: ['Jonelle', 'Jerome', 'Joan', 'Clinton', 'None'],
            when: ({ action }) => {
        ...
        },
        {
            type: 'list',
            name: 'updateEmployee',
            choices: ['Jonelle Harris', 'Jerome Harris', 'Joan Harris', 'Clinton Harris', 'Denessia Hepburn', 'Perry Hepburn', 'Jahneel Hepburn', 'Latonya Banton', 'Chauncey Haye', 'Naomi Haye', 'Lexy Bennett', 'Tamia Richards'],
